...
typedef SendfileC = Int32 Function(Int32 in_fd, Int32 out_fd, Int64 offset, Pointer<Int64> len, Pointer<Void> sf_hdtr, Int32 flags);
typedef SendfileDart = int Function(int in_fd, int out_fd, int offset, Pointer<Int64> len, Pointer<Void> sf_hdtr, int flags);
...
final errno_location = dylib.lookupFunction<ErrnoLocationC, ErrnoLocationDart>('__error');
