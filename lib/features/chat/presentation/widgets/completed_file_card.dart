                    ...
                    if (!isMine && fileExists && savedPath != null)
                      Builder(
                        builder: (context) {
                          ...
                          // Try to use Showcase, fallback to plain widget if not available
                          try {
                            return Showcase(
                              ...
                              title: 'Save File',
                              description:
                                  'Tap to save this file to your device storage',
                            ...
                            // ShowcaseView not in context, return plain widget
                            return saveButton;
                          }
                        },
                      ),
    ...
    if (showShowcase && !isMine) {
      try {
        return Showcase(
          ...
          title: 'Received File',
          description:
              'Tap on the file to open it, or use the Save button to permanently save it to your device',
          tooltipBackgroundColor: Colors.white,
          textColor: Colors.black,
